                      ...
                      messages: [
                        {
                          message: "Broken external link",
                          data: [
                            "https://github.com/mdn/learning-area/blob/main/tools-testing/cross-browser-testing/strategies/hidden-info-panel.html",
                            "The operation timed out."
                          ]
                        }
                      ]
                      ...
                      messages: [
                        {
                          message: "Broken external link",
                          data: [
                            "https://raw.githubusercontent.com/mdn/content/refs/heads/main/files/en-us/mdn/writing_guidelines/page_structures/sidebars/index.md",
                            "429 Retry-After: 300"
                          ]
                        }
                      ]
...
css.selectors.-webkit-resizer`,
                ...
                css_containment: {
                  children: {
                    container_queries: {
                      children: {},
                      slug: "/en-US/docs/Web/CSS/CSS_containment/Container_queries",
                      messages: [
                        {
                          message: "Self link",
                          data: [
                            "/en-US/docs/Web/CSS/CSS_containment/Container_queries"
                          ]
                        }
                      ]
                    },
                  ...
                  messages: [
                    {
                      ...
                      data: [
                        `
The mask image is repeated as many times as possi`
                      ]
                    },
                    {
                      message: "Quoted code",
...
svg.elements.feSpecularLighting.kernelUnitLength`
                        ...
                        "mask-type": {
                          children: {},
                          slug: "/en-US/docs/Web/SVG/Reference/Attribute/mask-type",
                          messages: [
                            {
                              message: "Unexpected BCD keys",
                              data: [
                                "Actual:",
                                "svg.elements.mask.mask-type",
                                "Expected:",
                                "[None]"
                              ]
                            }
